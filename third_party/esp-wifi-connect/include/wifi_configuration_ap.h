...
public:
    ...
    // Forward application-specific provisioning values without interpreting them.
    void OnProvisioningValue(
...
private:
    ...
    std::function<void(const std::string&, const std::string&)> on_provisioning_value_;
